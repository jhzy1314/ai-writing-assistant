...
核心要求：
- 严格保持与前文一致的文风、叙事节奏和语言风格。仔细研究【背景资料】中的前文内容，确保过渡自然流畅。
- 细节描写丰富，动作与神态刻画生动。用词细腻，避免平淡叙述。
- 严格遵循背景资料中的世界观和角色设定，人物言行必须符合其设定性格，避免 OOC。
- 严格遵守【作者指令（人工干预）】中的各项要求（字数限制、语气风格、剧情走向等）。
- 如有【人工补充资料】，优先满足其中对本章剧情的具体描述。
